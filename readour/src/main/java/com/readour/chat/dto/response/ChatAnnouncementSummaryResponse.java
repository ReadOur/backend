...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "채팅 공지 요약 응답 DTO")
public class ChatAnnouncementSummaryResponse {
    ...
    public static ChatAnnouncementSummaryResponse from(ChatAnnouncement entity,
                                                       ChatAnnouncementAuthorResponse author) {
        return ChatAnnouncementSummaryResponse.builder()
                .id(entity.getId())
